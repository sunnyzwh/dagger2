...
#line 174 "smarty_internal_configfileparser.php"
    ...
    const YY_NO_DAGGER_ACTION = 54;
    const YY_ACCEPT_DAGGER_ACTION = 53;
    const YY_ERROR_DAGGER_ACTION = 52;
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
		        ...
		        $expected = array_merge($expected, self::$yyExpectedTokens[$nextstate]);
                    ...
                    if ($nextstate < self::YYNSTATE) {
                        ...
                        // syntax error!
                        return array_unique($expected);
                    } elseif ($nextstate === self::YY_NO_DAGGER_ACTION) {
                        $this->yyidx = $yyidx;
                        $this->yystack = $stack;
   ...
   function yy_find_shift_action($iLookAhead)
    {
        ...
        /* if ($this->yyidx < 0) return self::YY_NO_DAGGER_ACTION;  */
        ...
        if ($iLookAhead == self::YYNOCODE) {
            return self::YY_NO_DAGGER_ACTION;
        }
        $i += $iLookAhead;
    ...
    function doParse($yymajor, $yytokenvalue)
    {
        ...
        do {
            ...
            if ($yymajor < self::YYERRORSYMBOL &&
                ...
                $yyact = self::YY_ERROR_DAGGER_ACTION;
            }
            if ($yyact < self::YYNSTATE) {
            ...
            } elseif ($yyact == self::YY_ERROR_DAGGER_ACTION) {
                if (self::$yyTraceFILE) {
